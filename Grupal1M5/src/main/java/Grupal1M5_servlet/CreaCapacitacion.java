...
public class CreaCapacitacion extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("RUT del cliente asociado: <input type=\"text\" name=\"rut\"><br>");
        ...
        out.println("Hora de la capacitación: <input type=\"time\" name=\"hora\"><br>");
        out.println("Fecha de la capacitación: <input type=\"date\" name=\"fecha\"><br>");
        out.println("Lugar de la capacitación: <input type=\"text\" name=\"lugar\"><br>");
        out.println("Cantidad de asistentes: <input type=\"number\" name=\"cantidad\"><br>");
